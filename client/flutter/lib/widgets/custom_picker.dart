...
class _CupertinoPickerState extends State<CupertinoPicker> {
  ...
  void _handleSelectedItemChanged(int index) {
    ...
    // intended effects.
    final bool hasSuitableHapticHardware = defaultTargetPlatform != TargetPlatform.windows;
          ...
          Positioned.fill(
            child: _CupertinoPickerSemantics(
              ...
              child: ListWheelScrollView.useDelegate(
                ...
                scrollBehavior: ScrollBehavior().copyWith(dragDevices: {...PointerDeviceKind.values}),
              ),
            ),
          ),
